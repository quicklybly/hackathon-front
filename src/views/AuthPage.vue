<template xmlns="http://www.w3.org/1999/html">
    <div class="content">
        <auth
                @reg="onChangeRegistration"
                @recovery="onChangeRecovery"
                v-if="!isRecovery && !isRegistration"/>
        <!--    <recovery-->
        <!--            @reg="onChangeRegistration"-->
        <!--            @recovery="onChangeRecovery"-->
        <!--            v-if="isRecovery"-->
...
export default {
    name: "SignInPage",
    components: {Registration, Recovery, Auth},
    data() {
        return {
            isRecovery: false,
